...
class BaseConfig(AttrDict):
    ...
    def __init__(self, filename=None, args=None, verbose=False, is_train=True):
        ...
        # Optimizer
        self.optimizer = AttrDict(type='adam',
                                  lr=0.0001,
                                  adam_beta1=0.0,
                                  adam_beta2=0.999,
                                  eps=1e-8,
    ...
    def load_configurations(self):
        ...
        assert os.path.exists(self.filename), 'File {} not exist.'.format(self.filename)
        ...
        try:
            ...
            print('Please check the file with name of "%s"', self.filename)
